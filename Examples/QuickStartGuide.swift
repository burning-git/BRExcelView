...
func example3_CustomStyle(in excelView: BRExcelView) {
    ...
    let headerRow = BRExcelRowModel(
        cells: [
            BRExcelCellModel(text: "科目", widthType: .auto, backgroundColor: .systemBlue, textColor: .white),
            BRExcelCellModel(text: "成绩", widthType: .fixed(80), backgroundColor: .systemBlue, textColor: .white)
        ],
        height: 50,
        isHeader: true
    )
